...
def seed_users():
    ...
    u5 = User(
        username='arkitekt', email='architecture_hunter@mail.com', profile_image='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/profile_pics/Screenshot+2021-12-11+161959.png', password='password')
    u6 = User(
        username='traveLVR', email='beatifuldestinations@mail.com', profile_image='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/profile_pics/beautifuldestinations_70407954_391397441514568_6341081271908696064_n.jpg', password='password')
    u7 = User(
        username='coryrichard', email='coryrichards@mail.com', profile_image='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/profile_pics/coryrichards_160305831_460242368407794_6869638752963182742_n.jpg', password='password')
    u8 = User(
