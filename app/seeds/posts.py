...
#******************************NASA**************************
    ...
    p25 = Post(user_id=1, description='')
    p26 = Post(user_id=3, description='')
    p27 = Post(user_id=3, description='')
    p28 = Post(user_id=3, description='')
    p29 = Post(user_id=3, description='')
    p30 = Post(user_id=3, description='')
    p31 = Post(user_id=3, description='')
    p32 = Post(user_id=3, description='')
    p33 = Post(user_id=3, description='')
    p34 = Post(user_id=3, description='')
    p35 = Post(user_id=3, description='')
    p36 = Post(user_id=3, description='')



    p37 = Post(user_id=3, description='')
    p38 = Post(user_id=3, description='')
    p39 = Post(user_id=3, description='')
    p40 = Post(user_id=3, description='')
    p41 = Post(user_id=3, description='')
    p42 = Post(user_id=3, description='')
    p43 = Post(user_id=3, description='')
    p44 = Post(user_id=3, description='')
    p45 = Post(user_id=3, description='')
    p46 = Post(user_id=3, description='')
    p47 = Post(user_id=3, description='')
    p48 = Post(user_id=3, description='')


    p49 = Post(user_id=3, description='')
    p50 = Post(user_id=3, description='')
    p51 = Post(user_id=3, description='')
    p52 = Post(user_id=3, description='')
    p53 = Post(user_id=3, description='')
    p54 = Post(user_id=3, description='')
    p55 = Post(user_id=3, description='')
    p56 = Post(user_id=3, description='')
    p57 = Post(user_id=3, description='')
    p58 = Post(user_id=3, description='')
    p59 = Post(user_id=3, description='')
    p60 = Post(user_id=3, description='')

    p61 = Post(user_id=3, description='')
    p62 = Post(user_id=3, description='')
    p63 = Post(user_id=3, description='')
    p64 = Post(user_id=3, description='')
    p65 = Post(user_id=3, description='')
    p66 = Post(user_id=3, description='')
    p67 = Post(user_id=3, description='')
    p68 = Post(user_id=3, description='')
    p69 = Post(user_id=3, description='')
    p70 = Post(user_id=3, description='')
    p71 = Post(user_id=3, description='')
    p72 = Post(user_id=3, description='')

    p73 = Post(user_id=3, description='')
    p74 = Post(user_id=3, description='')
    p75 = Post(user_id=3, description='')
    p76 = Post(user_id=3, description='')
    p77 = Post(user_id=3, description='')
    p78 = Post(user_id=3, description='')
    p79 = Post(user_id=3, description='')
    p80 = Post(user_id=3, description='')
    p81 = Post(user_id=3, description='')
    p82 = Post(user_id=3, description='')
    p83 = Post(user_id=3, description='')
    p84 = Post(user_id=3, description='')

    p85 = Post(user_id=3, description='')
    p86 = Post(user_id=3, description='')
    p87 = Post(user_id=3, description='')
    p88 = Post(user_id=3, description='')
    p89 = Post(user_id=3, description='')
    p90 = Post(user_id=3, description='')
    p91 = Post(user_id=3, description='')
    p92 = Post(user_id=3, description='')
    p93 = Post(user_id=3, description='')
    p94 = Post(user_id=3, description='')
    p95 = Post(user_id=3, description='')
    p96 = Post(user_id=3, description='')

    p97 = Post(user_id=3, description='')
    p98 = Post(user_id=3, description='')
    p99 = Post(user_id=3, description='')
    p100 = Post(user_id=3, description='')
    p101 = Post(user_id=3, description='')
    p102 = Post(user_id=3, description='')
    p103 = Post(user_id=3, description='')
    p104 = Post(user_id=3, description='')
    p105 = Post(user_id=3, description='')
    p106 = Post(user_id=3, description='')
    p107 = Post(user_id=3, description='')
    p108 = Post(user_id=3, description='')

    p109 = Post(user_id=3, description='')
    p110 = Post(user_id=3, description='')
    p111 = Post(user_id=3, description='')
    p112 = Post(user_id=3, description='')
    p113 = Post(user_id=3, description='')
    p114 = Post(user_id=3, description='')
    p115 = Post(user_id=3, description='')
    p116 = Post(user_id=3, description='')
    p117 = Post(user_id=3, description='')
    p118 = Post(user_id=3, description='')
    p119 = Post(user_id=3, description='')
    p120 = Post(user_id=3, description='')
