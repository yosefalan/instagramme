...
#******************************NASA**************************
    ...
    p92 = Post(user_id=9, description='')
    p93 = Post(user_id=9, description='')
    p94 = Post(user_id=9, description='')
    p95 = Post(user_id=9, description='')
    p96 = Post(user_id=9, description='')
