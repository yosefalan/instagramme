...
#******************************NASA**************************
    ...
    p80 = Post(user_id=8, description='')
    p81 = Post(user_id=8, description='')
    p82 = Post(user_id=8, description='')
    p83 = Post(user_id=8, description='')
    p84 = Post(user_id=8, description='')
