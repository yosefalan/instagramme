...
#******************************NASA**************************
    ...
    p16 = Post(
        ...
        The beauty of the landscape was so inspiring, in fact, that the mission team decided to add a little flair: they combined two versions of the black-and-white images from different times of the day and added colors to create a rare postcard from the Red Planet.""", createdAt=datetime.datetime(2021, 12, 3, 21, 49, 26))
    p17 = Post(
