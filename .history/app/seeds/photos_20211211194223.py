...
def seed_photos():
   ...
   #**********************************8th Damon**************************************
    ...
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/photified/1.jpg', user_id=5, post_id=7)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/photified/1.jpg', user_id=5, post_id=8)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/photified/1.jpg', user_id=5, post_id=9)
    photo24 = Photo(
