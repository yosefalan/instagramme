...
def seed_users():
    ...
    u6 = User(
        username='humzadeus', email='humzadeus@mail.com', profile_image='', password='password')
    u7 = User(
        username='photified', email='photified@mail.com', profile_image='', password='password')
    u8 = User(
        username='streetart', email='streetart@mail.com', profile_image='', password='password')
    u9 = User(
        username='tobishinobi', email='twouser@mail.com', profile_image='', password='password')
    u10 = User(
