...
def seed_users():
    ...
    u10 = User(
        username='beatifuldestination', email='architecture_hunter@mail.com', profile_image='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/profile_pics/Screenshot+2021-12-11+161959.png', password='password')
