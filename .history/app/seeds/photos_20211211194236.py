...
def seed_photos():
   ...
   #**********************************8th Damon**************************************
    ...
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/photified/2.jpg', user_id=5, post_id=2)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/photified/3.jpg', user_id=5, post_id=3)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/photified/4.jpg', user_id=5, post_id=4)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/photified/5.jpg', user_id=5, post_id=5)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/photified/6.jpg', user_id=5, post_id=6)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/photified/7.jpg', user_id=5, post_id=7)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/photified/8.jpg', user_id=5, post_id=8)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/photified/9.jpg', user_id=5, post_id=9)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/photified/10.jpg', user_id=5, post_id=10)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/photified/11.jpg', user_id=5, post_id=11)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/photified/12.jpg', user_id=5, post_id=12)
