...
def seed_posts():
    ...
    p8 = Post(
        ...
        """, createdAt=datetime.datetime(2021, 12, 3, 21, 49, 26))
    p9 = Post(
        user_id=2, description="""The month of October in Acadia National Park was spectacular. When the wind died at dusk, the colorful trees reflected perfectly in the still waters of Upper Hadlock Pond. See more from this fall in Maine""", createdAt=datetime.datetime(2021, 12, 3, 21, 49, 26))
