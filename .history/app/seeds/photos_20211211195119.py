...
def seed_photos():
   ...
   #**********************************8th Damon**************************************
    ...
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/tobishinobi/1.jpg', user_id=11, post_id=2)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/tobishinobi/1.jpg', user_id=11, post_id=3)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/tobishinobi/1.jpg', user_id=11, post_id=4)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/tobishinobi/1.jpg', user_id=11, post_id=5)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/tobishinobi/1.jpg', user_id=11, post_id=6)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/tobishinobi/1.jpg', user_id=11, post_id=7)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/tobishinobi/1.jpg', user_id=11, post_id=8)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/tobishinobi/1.jpg', user_id=11, post_id=9)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/tobishinobi/1.jpg', user_id=11, post_id=10)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/tobishinobi/1.jpg', user_id=11, post_id=11)
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/tobishinobi/1.jpg', user_id=11, post_id=12)
# photo8 = Photo(
#         url='', user_id=, post_id=)
