...
#******************************NASA**************************
    ...
    p65 = Post(user_id=7, description='', createdAt=datetime.datetime(2021, 12, 3, 21, 49, 26))
    p66 = Post(user_id=7, description='', createdAt=datetime.datetime(2021, 12, 3, 21, 49, 26))
    p67 = Post(user_id=7, description='', createdAt=datetime.datetime(2021, 12, 3, 21, 49, 26))
    p68 = Post(user_id=7, description='', createdAt=datetime.datetime(2021, 12, 3, 21, 49, 26))
    p69 = Post(user_id=7, description='', createdAt=datetime.datetime(2021, 12, 3, 21, 49, 26))
