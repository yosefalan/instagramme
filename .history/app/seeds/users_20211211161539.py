...
def seed_users():
    ...
    u9 = User(
        username='tobishinobi', email='twouser@mail.com', profile_image='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/profile_pics/tobishinobi_58950168_338527316861296_1427657913853280256_n.jpg', password='password')
    u10 = User(
        username='architecture_hunter', email='architecture_hunter@mail.com', profile_image='', password='password')
