...
def seed_photos():
   ...
   #**********************************8th Damon**************************************
    photo25 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/8thdamon/8thdamon_105407347_964981817264012_6157565110924147489_n.jpg', user_id=3, post_id=)
    photo26 = Photo(
