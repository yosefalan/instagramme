...
def seed_photos():
   ...
   #**********************************8th Damon**************************************
    ...
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/cory_richards/coryrichards_72346104_802552136859279_3378269993181439044_n.jpg', user_id=7, post_id=72)
       ...
       #**********************************humz 8**************************************
    photo73 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/humzadeas/humzadeas_264083408_342227241044688_8976157783667034759_n.jpg', user_id=8, post_id=)
    photo74 = Photo(
