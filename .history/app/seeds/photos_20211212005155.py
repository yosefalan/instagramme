...
def seed_photos():
   ...
   #**********************************8th Damon**************************************
    ...
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/photified/12.jpg', user_id=9, post_id=96)
        ...
        #**********************************street_art 10**************************************
    photo97 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/streetart/1.jpg', user_id=10, post_id=1=97)
    photo98 = Photo(
    ...
    photo102 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/streetart/6.jpg', user_id=10, post_id=1)
    photo103 = Photo(
