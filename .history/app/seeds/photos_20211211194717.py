...
def seed_photos():
   ...
   #**********************************8th Damon**************************************
    ...
    photohttps://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/streetart/1.jpg24 = Photo(
    url='', user_id=10, post_id=9)
    photo24 = Photo(
    url='', user_id=10, post_id=10)
    photo24 = Photo(
    url='', user_id=10, post_id=11)
    photo24 = Photo(
