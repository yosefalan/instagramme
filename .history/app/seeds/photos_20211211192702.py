...
def seed_photos():
   ...
   #**********************************8th Damon**************************************
    ...
    photo24 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/beautifuldestinations/beautifuldestinations_260656882_1209766549515975_6800547314011021984_n.mp4', user_id=6, post_id=3)
    photo24 = Photo(
    url='', user_id=6, post_id=4)
    photo24 = Photo(
    url='', user_id=6, post_id=5)
    photo24 = Photo(
    url='', user_id=6, post_id=6)
    photo24 = Photo(
    url='', user_id=6, post_id=7)
    photo24 = Photo(
    url='', user_id=6, post_id=8)
    photo24 = Photo(
    url='', user_id=6, post_id=9)
    photo24 = Photo(
    url='', user_id=6, post_id=10)
    photo24 = Photo(
    url='', user_id=6, post_id=11)
    photo24 = Photo(
    url='', user_id=6, post_id=12)
