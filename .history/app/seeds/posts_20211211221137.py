...
#******************************NASA**************************
    ...
    p25 = Post(user_id=, description='')
    p26 = Post(user_id=, description='')
    p27 = Post(user_id=, description='')
    p28 = Post(user_id=, description='')
    p29 = Post(user_id=, description='')
    p30 = Post(user_id=, description='')
    p31 = Post(user_id=, description='')
    p32 = Post(user_id=, description='')
    p33 = Post(user_id=, description='')
    p34 = Post(user_id=, description='')
    p35 = Post(user_id=, description='')
    p36 = Post(user_id=, description='')
