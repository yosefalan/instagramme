...
def seed_users():
    ...
    natgeo = User(
        username='natgeo', email='natgeo@mail.com',https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/profile_pics/natgeo_95140556_594026277870211_4156802974091313152_n.jpgpassword='password')
    nasa = User(
