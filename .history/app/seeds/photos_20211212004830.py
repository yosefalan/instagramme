...
def seed_photos():
   ...
   #**********************************8th Damon**************************************
    ...
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/arch_hunter/sophia-908215444535.jpg', user_id=5, post_id=48)
     ...
     #**********************************beaut_dest6**************************************
    photo49 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/beautifuldestinations/beautifuldestinations_252478748_5206206546075187_6491763116281153407_n.jpg', user_id=6, post_id=)
    photo50 = Photo(
