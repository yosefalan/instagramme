...
def seed_photos():
   ...
   #**********************************8th Damon**************************************
    ...
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/beautifuldestinations/Screenshot+2021-12-11+161311.png', user_id=6, post_id=60)
      ...
      #**********************************cory 7**************************************
    photo61 = Photo(
    url='https://mamba-instagramme.s3.us-east-2.amazonaws.com/seed_photos/cory_richards/coryrichards_118058982_730925541082069_5155584868589391019_n.jpg', user_id=7, post_id=)
    photo62 = Photo(
